import { Controls, MOUSE, Quaternion, Vector2, Vector3, MathUtils } from '../../../build/three.module.js'
    ...
    _panCamera() {
        ...
        if (_mouseChange.lengthSq()) {
            ...
            if (this.staticMoving) {
                ...
                this._panStart.add(
                    _mouseChange.subVectors(this._panEnd, this._panStart).multiplyScalar(this.dynamicDampingFactor)
                )
            }
        }
    }
