...
function WebGLExtensions(gl) {
	...
	return {
		has: (name) => getExtension(name) !== null,
...
class WebXRManager extends EventDispatcher {
	constructor(renderer, gl) {
		...
		this.getBaseLayer = () =>
			glProjLayer !== null ? glProjLayer : glBaseLayer;

		this.getBinding = () => glBinding;
...
class WebGLRenderer {
	constructor(parameters = {}) {
		...
		this.renderBufferDirect = (
			...
			if (drawCount < 0 || drawCount === Number.POSITIVE_INFINITY) return;
