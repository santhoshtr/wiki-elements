// biome-ignore format: Copied code from threejs
import {
	Controls,
	MOUSE,
	MathUtils,
...
class OrbitControls extends Controls {
	constructor(object, domElement = null) {
		...
		this.maxTargetRadius = Number.POSITIVE_INFINITY;
		...
		this.minAzimuthAngle = Number.NEGATIVE_INFINITY; // radians
		this.maxAzimuthAngle = Number.POSITIVE_INFINITY; // radians
