...
class WikiUser extends LazyLoadMixin(WikiElement) {
	...
	updateUser(userData) {
		...
		this.shadowRoot.querySelector(".editcount").textContent =
			this.getTotalEditCount(userData);
		this.shadowRoot.querySelector(".wikicount").textContent =
			this.getTotalWikis(userData);
