/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript&plugins=remove-initial-line-feed+normalize-whitespace+toolbar+copy-to-clipboard */
...
(() => {
	...
	NormalizeWhitespace.prototype = {
		 ...
		 */
		leftTrim: (input) => input.replace(/^\s+/, ""),
		rightTrim: (input) => input.replace(/\s+$/, ""),
		...
		removeTrailing: (input) => input.replace(/\s*?$/gm, ""),
		// Support for deprecated plugin remove-initial-line-feed
		removeInitialLineFeed: (input) => input.replace(/^(?:\r?\n|\r)/, ""),
		removeIndent: (input) => {
